...
export default function SignUp() {
  return (
    <Box
      ...
      style={{ backgroundColor: "#e4e4e4", marginTop: 150 }}
    >
...
lets sign up              </Button>
        ...
        <Grid item xs={12} md={6}>
          <img src="dental.png" alt="dental" className="signup-image" />
          <Typography variant="body1" paragraph className="signup-text">
